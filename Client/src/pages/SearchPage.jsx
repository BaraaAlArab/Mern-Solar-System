...
export default function Search() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-4 md:p-7 border-b md:border-r md:min-h-screen border-gray-500">
      ...
      <div className="w-full">
        ...
        <div className="p-4 md:p-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
